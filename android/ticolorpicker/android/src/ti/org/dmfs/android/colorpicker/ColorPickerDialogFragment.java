...
import ti.org.dmfs.android.colorpicker.PaletteFragment.OnColorSelectedListener;
 ...
 */
public class ColorPickerDialogFragment extends SupportDialogFragment implements
	...
	public interface ColorDialogResultListener {
		 ...
		 */
		public void onColorChanged(int color, String paletteId,
				String colorName, String paletteName);

		/**
		 * Called when the color picker dialog is cancelled without picking a
		 * color.
		 */
	...
	/**
	 * Switch to a specific palette with the given ID. Has no effect if no
	 * palette with that id is found.
	 * 
	 * @param id
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		View view = inflater.inflate(
				RHelper.getLayout("org_dmfs_colorpickerdialog_fragment"),
				container);

		mPager = (ViewPager) view.findViewById(RHelper.getId("pager"));
		mPagerAdapter = new PalettesPagerAdapter(getResources(),
				getChildFragmentManager(), mPalettes);
	...
	@Override
	public void onColorSelected(int color, String paletteId, String colorName,
			String paletteName) {
	...
	/**
	 * Get a {@link ColorDialogResultListener}. This should be either the parent
	 * {@link android.app.Fragment} or the parent {@link Activity}.
	 * 
	 * @return A {@link ColorDialogResultListener} or <code>null</code> if
	 *         neither the parent {@link Activity} nor the parent
	 *         {@link android.app.Fragment} implement this interface.
	 */
