 ...
 */
public class PaletteFragment extends SupportFragment implements
		OnItemClickListener {
	public interface OnColorSelectedListener {
		public void onColorSelected(int color, String paletteId,
	...
	public View onCreateView(final LayoutInflater inflater,
		...
		final ViewGroup rootView = (ViewGroup) inflater.inflate(
				RHelper.getLayout("org_dmfs_colorpickerdialog_palette_grid"),
				container, false);
				...
				new ViewTreeObserver.OnGlobalLayoutListener() {
					...
					public void onGlobalLayout() {
						...
						if (android.os.Build.VERSION.SDK_INT >= 16) {
							columnSpacing = gridview.getHorizontalSpacing()
							 ...
							 */
							DisplayMetrics metrics = inflater.getContext()
									.getResources().getDisplayMetrics();
							if (android.os.Build.VERSION.SDK_INT > 10) {
								columnSpacing = (int) TypedValue
										.applyDimension(
						...
						int columnWidth = (gridWidth - columnSpacing)
								/ mAdapter.getNumColumns();

						// estimated width of the grid
						int actualGridWidth = mAdapter.getNumColumns()
						...
						if (actualGridWidth < gridWidth - 1) {
							...
							if (padding > 0) {
								gridview.setPadding(padding, padding, padding,
										padding);
						...
						android.view.ViewGroup.LayoutParams params = gridview
								.getLayoutParams();
	...
	public void onItemClick(AdapterView<?> gridView, View View, int position,
		...
		if (parent instanceof OnColorSelectedListener) {
			...
			listener.onColorSelected(mPalette.getColor(position),
					mPalette.getId(), mPalette.getColorName(position),
					mPalette.getName());
		}
	}
}
